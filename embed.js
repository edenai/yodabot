window.addEventListener("load", () => {
  ...
  iframe.style.width="90%",iframe.style.maxWidth="90%",iframe.classList.add("mobile"))
  :(document.getElementById("edenai-message-iframe-container").style.width="400px",iframe.classList.contains("mobile")&&(iframe.classList.remove("mobile")
  ,ref[0].style.marginTop="26%!important")),window.addEventListener("resize",
  (function(e){const t=document.getElementById("edenai-message-iframe-container");
  let i=window.innerWidth;const s=document.getElementsByClassName("visible");
  i<760&&s?(t.style.width="90%",t.style.maxWidth="90%",t.classList.add("mobile"),
  s[0].style.border="solid 1px #255fff",s[0].style.marginTop="41%!important"):(document.getElementById("edenai-message-iframe-container")
  .style.width="400px",t.classList.contains("mobile")&&(t.classList.remove("mobile"),s[0].style.marginTop="26%!important"))}));
  });
